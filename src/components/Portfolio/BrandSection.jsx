...
const BrandSection = ({ portfolioData }) => (
    <Section id="brands" title="The Brands I've Worked With" className="bg-white dark:bg-[var(--color-black)]">
        <ContentCard className="bg-white dark:bg-[var(--color-black)] my-4">
