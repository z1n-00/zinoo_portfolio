...
const Navigation = ({ activeSection, scrollToSection }) => (
    <nav className="fixed bottom-2 md:top-1/2 md:-translate-y-1/2 left-1/2 -translate-x-1/2 md:left-4 md:translate-x-0 z-50 p-0">
        <motion.div
        ...
        >
            <NavCard className="flex md:flex-col md:gap-4 gap-1 text-black text-white backdrop-blur-xs">
